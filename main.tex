...
\textit{Note--} During the reviewing process of this manuscript, the authors became aware of a related work~\cite{Zhanwei_oamCNN}, \add{that addresses the classification of scalar fields with fractional topological charge}. %\add{Unlike our manuscript, whose purpose requires the ability to capture information stored in both the orbital angular momentum (encoded into the integer quantum numbers
